...
class FabricMultiSelect extends HTMLElement {
    ...
    set value(value) { value = [].concat(value); if (value.sort().join(',') === this._value.sort().join(','))
    ...
    __addListeners() {
        if (this._refs.controls)
            this._refs.controls.addEventListener('click', (e) => {
    ...
    attributeChangedCallback(attr, oldValue, newValue) {
        let n = (attr === 'value') ? newValue.split(',') : newValue;
