...
var FabricTable = (function (_super) {
    ...
    Object.defineProperty(FabricTable.prototype, "itemheight", {
        get: function () { return this._itemheight || 20; },
        set: function (value) {
            if (value == null)
                return;
    ...
    FabricTable.prototype.__setupUI = function () {
        ...
        var markup = "<div class=\"container\"><div class=\"displayHeader\"></div><div class=\"scroller\" data-id=\"scroller\">\n\t\t\t<table class=\"ms-Table " + modifier + "\"><thead><tr></tr></thead><tbody></tbody></table>\n\t\t</div></div>";
    ...
    FabricTable.prototype.__setProperties = function (property) {
        ...
        if (property == null || property === 'columns') {
            if (this._refs.table) {
                ...
                var headContent = ['<tr>'], displayHeaderContent = [], rowCheck = 0;
                if (this._modifier === 'selectable') {
                ...
                var b = displayHeaderContent.concat(this._columns.map(function (col) { return '<span style="float:left;width: ' + (col.width || '0') + ';" class="text">' + (col.label || '') + '</span>'; })).join('');
