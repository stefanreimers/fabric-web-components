class FabricCommandBar extends HTMLElement {
  ...
  set navbar(value) { if (!!value === this._navbar) return; this._navbar = !!value; this.__setProperties('navbar') }
  ...
  private __setupUI() {
    ...
    [].forEach.call(this.querySelectorAll('fabric-command-button'), (f: FabricCommandButton) => {
